/**
 * Modern Browsers support some newer additions to javaScript that make use of additional threads.
 * one of these newer addition is web worker.
...
/**
 * @param(scriptInOtherFile) : refer to a script that should be executed by the worker.
 *
 */
const worker = new Worker(scriptInOtherFile);
